...
const PipelineErrors: React.FC = () => {
  ...
  const fetchErrors = useCallback(async (page: number = pagination.currentPage) => {
    ...
    setIsLoading(true)
    try {
      const response = await apiService.getStageErrors(stageId, page, pagination.itemsPerPage)
  ...
  }, [stageId, pagination.itemsPerPage])
    ...
    <div className="bg-gray-50">
      ...
      <div className="bg-museum-green px-6 py-4">
        <div className="flex items-center gap-4">
          <button
            onClick={() => navigate('/tools/data-pipeline')}
          ...
          <div>
            <h1 className="text-xl font-semibold text-white">Pipeline Errors</h1>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-amber-50 rounded-lg border border-amber-200">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-amber-700">Total Records</p>
              </div>
            </div>
          </div>
          <button
        ...
        {isLoading && errors.length === 0 ? (
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-12 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">
              There are no errors for this pipeline stage.
            </p>
          </div>
        ) : (
                  ...
                  {errors.map((error, idx) => {
                    ...
                    return (
                      <tr 
                        ...
                        onClick={() => navigate(`/tools/data-pipeline/errors/${stageId}/records?error=${encodeURIComponent(error.error_text)}`)}
                      >
